...
class ProcesoEtlCargaPreguntas(db.Database):
    __tablename__ = 'proceso_etl_carga_preguntas'
    
    id_proceso_carga_preguntas = Column(Integer, primary_key = True)
    ...
    proceso_etl = relationship("ProcesoEtl", back_populates = "proceso_etl_carga_preguntas")
    
    opciones_carga_preguntas = relationship("OpcionesEtlCargaPreguntas", back_populates = "proceso_etl_carga_preguntas")
