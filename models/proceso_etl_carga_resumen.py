...
class ProcesoEtlCargaResumenSimple(db.Database):
    __tablename__ = 'proceso_etl_carga_resumenes'
    
    id_proceso_carga_resumen = Column(Integer, primary_key=True)
    ...
    proceso_etl = relationship("ProcesoEtl", back_populates = "proceso_etl_resumen_simple")
    
    opciones_carga_resumen = relationship("OpcionesEtlCargaResumen", back_populates = "proceso_etl_carga_resumen")
