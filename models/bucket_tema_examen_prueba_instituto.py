...
class BucketTemaPruebaInstituto(db.Database):
    __tablename__ = "bucket_tema_exp_ins"
    ...
    deficiencias = relationship("BucketDeficienciaPruebaInstituto")
    
    def __init__(self, bucket_tema_exp_id, institucion_id,
